...
public class SubscriptionPlans {
    ...
    // Constructor
    public SubscriptionPlans(WebDriver driver) {
    ...
    public void checkLitePackageNameEN(String actual){
        ...
        //test.log(Status.PASS, "Test PASSED for verify the Lite package name in English");
    }
    ...
    public void checkLitePackagePriceEN(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Lite package price in English");
    }
    ...
    public void checkLiteCurrencyPriceEN(String actual){
        ...
        //test.log(Status.PASS, "Test PASSED for verify the Lite package currency in English");
    }
    ...
    public void checkLitePackageNameAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Lite package name in Arabic");
    }
    ...
    public void checkLitePackagePriceAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Lite package price in Arabic");
    }
    ...
    public void checkLiteCurrencyPriceAR(String actual){
        ...
        String currency = testHelper.extractCurrency(currencyText);
        Assert.assertEquals(actual, currency);
        //test.log(Status.PASS, "Test PASSED for verify the Lite package currency in Arabic");
    }
    ...
    public void checkClassicPackageNameEN(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package name in English");
    }
    ...
    public void checkClassicPackagePriceEN(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package price in English");
    }
    ...
    public void checkClassicCurrencyPriceEN(String actual){
        ...
        String currency = testHelper.extractCurrency(currencyText);
        Assert.assertEquals(actual, currency);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package currency in English");
    }
    ...
    public void checkClassicPackageNameAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package name in Arabic");
    }
    ...
    public void checkClassicPackagePriceAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package price in Arabic");
    }
    ...
    public void checkClassicCurrencyPriceAR(String actual){
        ...
        String currency = testHelper.extractCurrency(currencyText);
        Assert.assertEquals(actual, currency);
        //test.log(Status.PASS, "Test PASSED for verify the Classic package currency in Arabic");
    }
    ...
    public void checkPremiumPackageNameEN(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package name in English");
    }
    ...
    public void checkPremiumPackagePriceEN(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package price in English");
    }
    ...
    public void checkPremiumCurrencyPriceEN(String actual){
        ...
        String currency = testHelper.extractCurrency(currencyText);
        Assert.assertEquals(actual, currency);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package currency in English");
    }
    ...
    public void checkPremiumPackageNameAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package name in Arabic");
    }
    ...
    public void checkPremiumPackagePriceAR(String actual){
        ...
        testHelper.compareText(actual, expected);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package price in Arabic");
    }
    ...
    public void checkPremiumCurrencyPriceAR(String actual){
        ...
        String currency = testHelper.extractCurrency(currencyText);
        Assert.assertEquals(actual, currency);
        //test.log(Status.PASS, "Test PASSED for verify the Premium package currency in Arabic");
    }
}